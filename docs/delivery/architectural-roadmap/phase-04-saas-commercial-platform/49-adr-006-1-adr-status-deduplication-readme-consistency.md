...
- `docs/delivery/architectural-roadmap/phase-04-saas-commercial-platform/48-adr-006-billing-provider-abstraction.md` — adicionada
...
- `docs/delivery/architectural-roadmap/phase-04-saas-commercial-platform/49-adr-006-1-adr-status-deduplication-readme-consistency.md`
  (este relatório).
...
- **Arquivos alterados:** `docs/delivery/architectural-roadmap/phase-04-saas-commercial-platform/48-adr-006-billing-provider-abstraction.md` (nota de retificação).
- **Arquivos criados:** `docs/delivery/architectural-roadmap/phase-04-saas-commercial-platform/49-adr-006-1-adr-status-deduplication-readme-consistency.md`.
- **Migrations:** nenhuma.
