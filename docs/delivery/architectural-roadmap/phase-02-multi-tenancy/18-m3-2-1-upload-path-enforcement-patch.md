...
| `docs/delivery/architectural-roadmap/phase-02-multi-tenancy/17-m3-2-new-upload-path-enforcement.md` | documental | Redação arquiteturalmente precisa sobre autoridade do path e atualização dos riscos remanescentes. |
...
| `docs/delivery/architectural-roadmap/phase-02-multi-tenancy/18-m3-2-1-upload-path-enforcement-patch.md` | novo | Este relatório. |
