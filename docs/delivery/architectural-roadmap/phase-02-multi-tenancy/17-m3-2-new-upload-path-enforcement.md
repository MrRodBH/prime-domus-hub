...
| `docs/delivery/architectural-roadmap/phase-02-multi-tenancy/17-m3-2-new-upload-path-enforcement.md` | novo | Este relatório. |
...
| Media Picker (`src/components/admin/MediaPicker.tsx`) e fluxo de leitura/uso na biblioteca central de mídias | **M3.5 — Media Picker Validation** (o endurecimento de `registrarMidia` foi antecipado pelo Patch M3.2.1 — ver `docs/delivery/architectural-roadmap/phase-02-multi-tenancy/18-m3-2-1-upload-path-enforcement-patch.md`) |
