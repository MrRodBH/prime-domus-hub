...
| `docs/delivery/architectural-roadmap/phase-03-membership-evolution/39-f3-5-tenant-switcher-ux.md` | Este relatório. |
...
- `run-tenant-specs.ts`
- `docs/delivery/architectural-roadmap/phase-03-membership-evolution/39-f3-5-tenant-switcher-ux.md`
