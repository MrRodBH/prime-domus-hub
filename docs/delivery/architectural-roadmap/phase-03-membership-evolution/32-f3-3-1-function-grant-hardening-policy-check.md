...
5. Cenários F3.3 (13/17/21 asserções sobre `get_current_tenant_id()`):
   ...
   asserções PASS registradas em `docs/delivery/architectural-roadmap/phase-03-membership-evolution/31-f3-3-...md §9` permanecem
...
em `docs/delivery/architectural-roadmap/phase-03-membership-evolution/31-...md §9` permanecem verdadeiras por construção.
