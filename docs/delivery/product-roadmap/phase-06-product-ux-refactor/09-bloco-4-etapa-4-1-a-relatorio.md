...
**Contrato normativo:** `docs/delivery/product-roadmap/phase-06-product-ux-refactor/09-product-ux-contract.md` (§12 — Three-Domain Rule)
**Plano Executivo:** `docs/delivery/product-roadmap/phase-06-product-ux-refactor/09-bloco-4-etapa-4-1-plano-executivo.md`
...
- **`docs/delivery/product-roadmap/phase-06-product-ux-refactor/09-product-ux-contract.md` §12 (novo)** — Three-Domain Rule
...
- **`docs/delivery/product-roadmap/phase-06-product-ux-refactor/09-bloco-4-etapa-4-1-plano-executivo.md`** — permanece a
