...
- `docs/fase6/52-scp-001-commercial-domain-model.md` — adicionada
  nota `## Retificação SCP-001.1` ao final, sem apagar histórico.

## 3. Arquivos criados

- `docs/fase6/53-scp-001-1-f4-0-accepted-status-final-cleanup.md`
...
- Relatório `docs/fase6/52-scp-001-commercial-domain-model.md`:
...
- **Arquivos alterados:** `docs/fase6/52-scp-001-commercial-domain-model.md`.
- **Arquivos criados:** `docs/fase6/53-scp-001-1-f4-0-accepted-status-final-cleanup.md`.
- **Migrations:** nenhuma.
