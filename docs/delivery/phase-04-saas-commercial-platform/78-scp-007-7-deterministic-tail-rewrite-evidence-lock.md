...
- `docs/fase6/73-scp-007-2-accepted-status-finalization-roadmap-gate-cleanup.md` — tail (`## Correction Note` + `## 6. Próximo passo recomendado`) reescrito integralmente via script determinístico.
- `docs/fase6/75-scp-007-4-correction-note-next-step-deduplication-cleanup.md` — tail reescrito integralmente via script determinístico.
- `docs/fase6/76-scp-007-5-hard-tail-replacement-evidence-correction.md` — tail reescrito integralmente via script determinístico.
- `docs/fase6/77-scp-007-6-dual-tail-hard-replacement-final-evidence-cleanup.md` — recebeu nota corretiva única confirmando fechamento pela SCP-007.7.
- `docs/fase6/78-scp-007-7-deterministic-tail-rewrite-evidence-lock.md` — este relatório.
