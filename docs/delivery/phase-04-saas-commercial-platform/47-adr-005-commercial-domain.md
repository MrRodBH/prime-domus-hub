...
- `docs/fase6/47-adr-005-commercial-domain.md` (este relatório)
...
- **Arquivos criados:** `docs/architecture/ADR/ADR-005-commercial-domain.md`, `docs/fase6/47-adr-005-commercial-domain.md`.
