...
- `docs/fase6/47-adr-005-commercial-domain.md`

## 3. Arquivos criados

- `docs/architecture/ADR/ADR-006-billing-provider-abstraction.md`
- `docs/fase6/48-adr-006-billing-provider-abstraction.md` (este relatório)
...
- **Arquivos criados:** `docs/architecture/ADR/ADR-006-billing-provider-abstraction.md`, `docs/fase6/48-adr-006-billing-provider-abstraction.md`.
