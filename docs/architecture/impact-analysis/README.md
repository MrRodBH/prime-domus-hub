...
- [IA-004 — Tenant Storage Isolation](./IA-004-TenantStorageIsolation.md) — 🟡 Em execução controlada · **M3 permanece BLOQUEADA para migração de legado** · M3.1 concluída ([`docs/fase6/15-m3-1-storage-inventory-classification.md`](../../fase6/15-m3-1-storage-inventory-classification.md)) · M3.2 + Patch M3.2.1 concluídos ([`docs/fase6/17-m3-2-new-upload-path-enforcement.md`](../../fase6/17-m3-2-new-upload-path-enforcement.md), [`docs/fase6/18-m3-2-1-upload-path-enforcement-patch.md`](../../fase6/18-m3-2-1-upload-path-enforcement-patch.md)) · **M3.4 implementada, aguardando auditoria** ([`docs/fase6/19-m3-4-signed-url-hardening.md`](../../fase6/19-m3-4-signed-url-hardening.md)) · **M3.3 e M3.5 BLOCKED**
