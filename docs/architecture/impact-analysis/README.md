...
- [IA-004 — Tenant Storage Isolation](./IA-004-TenantStorageIsolation.md) — 🟡 Em execução controlada · M3.1 concluída ([`docs/fase6/15-m3-1-storage-inventory-classification.md`](../../fase6/15-m3-1-storage-inventory-classification.md)) · M3.2 + Patch M3.2.1 **aprovados** ([`17`](../../fase6/17-m3-2-new-upload-path-enforcement.md), [`18`](../../fase6/18-m3-2-1-upload-path-enforcement-patch.md)) · **M3.4 implementada, aguardando auditoria/aprovação** ([`19`](../../fase6/19-m3-4-signed-url-hardening.md)) · **M3.3 implementada, aguardando auditoria/aprovação** ([`21`](../../fase6/21-m3-3-legacy-file-migration.md)) · **M3.5 BLOCKED**
