...
- [IA-003 — RLS Policies](./IA-003-RLSPolicies.md) — 🟢 Aprovada · M2b implementada (`docs/delivery/phase-02-multi-tenancy/11-fase-2-m2b-relatorio.md`) + Audit Clarification Report (`docs/delivery/phase-02-multi-tenancy/12-m2b-audit-clarification-report.md`) + Patch M2b.1 (`docs/delivery/phase-02-multi-tenancy/13-m2b-1-get-current-tenant-id-cardinality-fix.md`)
