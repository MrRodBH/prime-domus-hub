...
- [IA-004 — Tenant Storage Isolation](./IA-004-TenantStorageIsolation.md) — 🟡 Em execução controlada · **M3 permanece BLOQUEADA para migração de legado** · M3.1 concluída ([`docs/fase6/15-m3-1-storage-inventory-classification.md`](../../fase6/15-m3-1-storage-inventory-classification.md)) · M3.2 implementada + **Patch M3.2.1** aguardando auditoria ([`docs/fase6/17-m3-2-new-upload-path-enforcement.md`](../../fase6/17-m3-2-new-upload-path-enforcement.md), [`docs/fase6/18-m3-2-1-upload-path-enforcement-patch.md`](../../fase6/18-m3-2-1-upload-path-enforcement-patch.md)) · **M3.3 BLOCKED**
