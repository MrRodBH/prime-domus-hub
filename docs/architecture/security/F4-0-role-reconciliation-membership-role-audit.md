...
- IA-006.1/2/3 — `docs/delivery/architectural-roadmap/phase-04-saas-commercial-platform/44..46-*.md`
...
- F3.1 — `docs/delivery/architectural-roadmap/phase-03-membership-evolution/28-f3-1-membership-schema-foundation.md`
- F3.6 — `docs/delivery/architectural-roadmap/phase-03-membership-evolution/41-f3-6-membership-roles-status-validation.md`
