...
```
rg -n "## Status|Accepted" docs/fase6/58-scp-004-commercial-server-read-functions.md
```
...
```
rg -n "## Status|Accepted" docs/fase6/59-scp-004-1-commercial-diagnostic-boundary-documentation-cleanup.md
```
