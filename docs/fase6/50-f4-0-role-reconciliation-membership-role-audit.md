...
- `docs/fase6/28-f3-1-membership-schema-foundation.md`
- `docs/fase6/41-f3-6-membership-roles-status-validation.md`

## 4. Arquivos criados

- `docs/architecture/security/F4-0-role-reconciliation-membership-role-audit.md`
- `docs/fase6/50-f4-0-role-reconciliation-membership-role-audit.md`
...
- Arquivos criados: `docs/architecture/security/F4-0-role-reconciliation-membership-role-audit.md`; `docs/fase6/50-f4-0-role-reconciliation-membership-role-audit.md`.
