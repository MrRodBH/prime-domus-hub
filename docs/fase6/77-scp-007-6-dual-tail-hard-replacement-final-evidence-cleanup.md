...
- `docs/fase6/75-scp-007-4-correction-note-next-step-deduplication-cleanup.md` — conteúdo a partir de `## Correction Note` substituído integralmente pelo bloco final obrigatório; mantida apenas uma redação em `## Correction Note` e apenas uma redação em `## 6. Próximo passo recomendado`.
- `docs/fase6/76-scp-007-5-hard-tail-replacement-evidence-correction.md` — adicionada `## Correction Note` confirmando que a SCP-007.5 ainda deixou duplicidade textual nos relatórios da SCP-007.2 e SCP-007.4 e que a limpeza final foi concluída pela SCP-007.6; status permanece inalterado.
- `docs/fase6/77-scp-007-6-dual-tail-hard-replacement-final-evidence-cleanup.md` — criado (este relatório).
...
- `rg -n "Aguardar auditoria externa da SCP-007" docs/fase6/73-scp-007-2-accepted-status-finalization-roadmap-gate-cleanup.md docs/fase6/75-scp-007-4-correction-note-next-step-deduplication-cleanup.md` — 1 ocorrência em cada arquivo.
- `rg -n "## Correction Note|## 6\. Próximo passo recomendado" docs/fase6/73-scp-007-2-accepted-status-finalization-roadmap-gate-cleanup.md docs/fase6/75-scp-007-4-correction-note-next-step-deduplication-cleanup.md` — 1 ocorrência de `## Correction Note` em cada arquivo; 1 ocorrência de `## 6. Próximo passo recomendado` em cada arquivo.
...
- `sed -n '/## Correction Note/,$p' docs/fase6/75-scp-007-4-correction-note-next-step-deduplication-cleanup.md` — trecho final contém apenas a redação única de `## Correction Note` e a redação única de `## 6. Próximo passo recomendado`.
