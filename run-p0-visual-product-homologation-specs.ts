...
const auth = read("src/components/auth/AuthPage.tsx");
ok(read("src/routes/auth.tsx").includes("component: AuthPage"), "platform route must use the shared authentication form");
