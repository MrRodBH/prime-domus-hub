import { acceptedHistoricalPaths } from "./scripts/owned-origin-historical-scope.mjs";
...
assert.deepEqual(
  ...
  [],
  "PCA-12B plus sanctioned PCA-12C-R3/R6A/R6D/R6G diff escaped the repository allowlist",
);
